    ...
    <div class="t_content" v-if="tab==2">
      ...
      <div class="t_dao">
        ...
        <div class="numer">
          ...
          <span class="add" :class="pull==1?on:''" @click="addtimer_hour(true)">+</span> {{d_hour}}
        ...
        <div class="numer">
          ...
          <span class="add" :class="pull==1?on:''" @click="addtimer_minutes(true)">+</span> {{d_minutes}}
        ...
        <div class="numer">
          ...
          <span class="add" :class="pull==1?on:''" @click="addtimer_seconds(true)">+</span> {{d_seconds}}
