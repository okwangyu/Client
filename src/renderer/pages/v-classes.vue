<template>
  <div class="classesbg">
    ...
    <div class="addmyclass" v-if="!spinShow">
            ...
            <div class="add">
                <div class="classes" v-for="(item,index) in lists" :key="index">
               ...
               <Dropdown trigger="click">
                ...
                <Dropdown-menu slot="list">
                  <!-- <Dropdown-item><span @click="setting(item)">班级设置</span></Dropdown-item> -->
                ...
                <div class="jion" @click="addClasse.show = true" v-waves.block>
...
<script>
   ...
   export default {
    ...
    methods: {
      ...
      setting(item){
        this.$store.commit('add_current_classes',item)
        this.$router.push({
            name: 'setclass', 
    ...
    components:{
          vHeader,VSubject,vLoading,vAddClasse,vMenu
    }
  }
</script>
<style scoped>
